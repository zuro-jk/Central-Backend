package com.centrral.centralres.core.audit.listener;
...
import com.centrral.centralres.core.audit.service.AuditLogService;
import com.centrral.centralres.core.model.Auditable;
import com.centrral.centralres.core.utils.SecurityUtils;
...
public class AuditableEntityListener {
    ...
    public static Map<String, Object> snapshotEntity(Object entity) {
        ...
        for (Field field : entity.getClass().getDeclaredFields()) {
            try {
                ...
                log.error("Error accediendo al campo '{}' de {}: {}", field.getName(), entity.getClass(),
                        e.getMessage());
            }
        }
    ...
    private static Long getEntityId(Object entity) {
        ...
        if (entity instanceof HibernateProxy proxy) {
            ...
            if (impl instanceof Auditable real)
                return real.getId();
        }
    ...
    private static void logSafe(String entityName, Long entityId, String action,
        ...
        try {
            ...
            log.error("Error serializando log para {} id={} acción={}: {}", entityName, entityId, action,
                    e.getMessage(), e);
            try {
